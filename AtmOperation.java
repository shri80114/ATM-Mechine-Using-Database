...
//			System.out.println(AccountHolderName);
	...
	public void MoneyTransfer(Connection con) throws Throwable {
		...
		if (password == pass1  ) { ////&& UserName == userName
			...
			//"update hdfcbank set balance = balance + ? where name = '" + AccountHolderName + "';";
			String query121="update hdfcbank set balance = balance - ? where name = '" + AccountHolderName + "';";
			PreparedStatement psmt121 = con.prepareStatement(query121);
			psmt121.setDouble(1, amount);
			psmt121.executeUpdate();
		
			// insert transaction details of AccountHolder user 
			...
			psmt9.executeUpdate();
			// insert transaction details of userName 
